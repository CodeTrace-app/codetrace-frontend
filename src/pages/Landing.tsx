  ...
  return (
    <div className="landing-wrapper">
      <header className="landing-header">
        <div className="logo">CodeTrace</div>
      ...
      <section className="hero-section">
        ...
        <div className="hero-buttons">
          ...
          <button className="btn-secondary">요금제 보기</button>
        </div>
      </section>
      ...
      <section className="content-section">
        ...
        <div className="card-container">
          <div className="card">
            <span className="card-label">신규 합류 후 코드 맥락 파악</span>
            <h3>평균 3~4주 소요</h3>
            <p>인터뷰에 응한 현직 개발자 8명 중 87%가 사수 문의를 대체할 도구가 없다고 응답했습니다.</p>
          </div>
          <div className="card">
            <span className="card-label">AI 코딩 도구 한계</span>
            <h3>맥락 없는 응답</h3>
            <p>범용 LLM은 왜 이 코드가 이렇게 작성됐는지 설명하지 못합니다. 커밋 이력이 없기 때문입니다.</p>
          </div>
          <div className="card">
            <span className="card-label">PR 리뷰 사각지대</span>
            <h3>숨겨진 영향 범위</h3>
      ...
      <section className="content-section">
        ...
        <div className="card-container">
          <div className="card">
            <h3>작성 배경 추적</h3>
            <p>선택한 함수나 코드 블록에 연결된 커밋 메시지와 PR 리뷰를 근거로 작성 배경을 자연어로 요약합니다.<br/><br/>근거가 없을 때는 추측하지 않고 근거 부족을 명시합니다.</p>
          </div>
          <div className="card">
            <h3>영향 범위 분석</h3>
            <p>특정 함수를 변경하면 어디에 영향이 가는지 2단계 깊이의 호출 그래프로 즉시 확인합니다.<br/><br/>15개 초과 노드는 자동 접기로 과열을 방지합니다.</p>
          </div>
          <div className="card">
            <h3>PR 사전 경고</h3>
            <p>PR 생성 시 시그니처 변경, 함수 삭제가 감지되면 영향받는 미수정 참조 지점을 코멘트로 자동 기록합니다.<br/><br/>자동 수정이나 머지 차단 없이 참고 수준으로 제공합니다.</p>
          </div>
        </div>
      </section>
      ...
      <section className="content-section">
        ...
        <div className="demo-container">
          ...
          <div className="demo-action-card">
            <h4>데모 레포 체험</h4>
            <p>2년차 커밋 이력이 심긴 샘플 레포를 로그인 없이 바로 탐색해 볼 수 있습니다.</p>
            <button className="btn-primary full-width">코드 탐색기 바로 열기</button>
          </div>
        </div>
      </section>
